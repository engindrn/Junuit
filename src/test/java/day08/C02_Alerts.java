...
public class C02_Alerts {
    ...
    //testleri ayrı ayrı çalıştıracağız bu yüzden her test methoduna driver.get() methodunun kullanacaz
    ...
    public void test1() throws InterruptedException {
        ...
        WebElement mesajinTagı = driver.findElement(By.xpath("//*[@id='result']"));
        String actualMesaj = mesajinTagı.getText();
