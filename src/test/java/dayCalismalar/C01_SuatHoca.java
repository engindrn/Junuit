...
public class C01_SuatHoca {
    ...
    public void Test(){
        ...
        //    10. gelen ürün sayfalarında 3. sayfaya gidelim
        ...
        //    11. 3. sayfada oldugunumuzu doğrulayalım
        String actualUrl=driver.getCurrentUrl();
        Assert.assertTrue(actualUrl.contains("page=3"));

        //    12. sayfadaki 3. ürünü secelim.
        String secilenUrunTitle=secilenUrunTitleAl(3);

        urunuSec(3);

        //    13. açılan sayfada 3. ürünü seçdiğimiz doğrulayalım
        ...
        //    14. seçtiğimiz ürünü sepete atalım.
        driver.findElement(By.cssSelector("[id=\"add-to-cart-button\"]")).click();

        //    15. ürünümüzü listemize attığımızı doğrulayalım.
        ...
        //    17. listemizden ürünümüz silelim.
        driver.findElement(By.xpath("//input[@value=\"Sil\" and @data-action=\"delete\"]")).click();

        //    18. listemizden ürünümüzn silindigini doğrulayalım.
