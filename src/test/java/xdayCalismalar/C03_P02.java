...
public class C03_P02 extends TestBaseBeforeAfter {
...
//        }
        ...
        for (int i = 0; i <boxes.size() ; i++) {//boxun size ına kadar gel diyorum.
            boxes.get(i).sendKeys(text.get(i));;//birinci boxa textin (stringimi)birinci indexini koydum yani 0. indexten baslayacak.
