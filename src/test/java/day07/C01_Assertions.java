...
public class C01_Assertions {
    ...
    public void method1(){
        ...
        WebElement location= driver.findElement(By.xpath("//*[@id='email_create']"));
        location.sendKeys("enghotmail.com");

        WebElement login= driver.findElement(By.xpath("//*[@id='SubmitCreate']"));
        login.click();
